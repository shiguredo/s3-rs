...
pub use output::{
    ...
    ListBucketsOutput, ListMultipartUploadsOutput, ListObjectVersionsOutput, ListObjectsV2Output,
    ListPartsOutput, MultipartUpload, Object, ObjectVersion, Owner, Part, PutBucketCorsOutput,
    PutBucketEncryptionOutput, PutBucketLifecycleConfigurationOutput,
